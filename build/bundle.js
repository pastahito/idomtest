...
// App
// React v16 & React Router v4 & Redux
...
var _Gauge = __webpack_require__(51);
...
var App = function (_Component) {
    ...
    function App(props) {
        ...
        _this.updateTemperature = function (newValue) {
            _this.setState({ temperature: newValue });
        };

        _this.updateGauge = function () {};
        _this.setUpdater = function (newFunction) {
            _this.updateGauge = newFunction;
        };

        _socket2.default.on('temperature', function (data) {
            var t = Number.parseInt(data) || 0;
            console.log(t);
            _this.updateTemperature(t);
            _this.updateGauge(t);
        });
    ...
    _createClass(App, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_Gauge2.default, { updateD3: this.setUpdater })
            );
        }
    }]);
...
var Gauge = function (_Component) {
    ...
    function Gauge(props) {
        ...
        return _possibleConstructorReturn(this, (Gauge.__proto__ || Object.getPrototypeOf(Gauge)).call(this, props));
    }
    ...
    _createClass(Gauge, [{
        ...
        value: function componentDidMount() {
            ...
            var domain = [0, 100];
            var gg = viz.gg().domain(domain).outerRadius(300).innerRadius(30).value(0.5 * (domain[1] + domain[0])).duration(500);

            gg.defs(svg);
            g.call(gg);

            this.props.updateD3(function (t) {
                return gg.setNeedle(t);
            });
        }
    }, {
        key: 'render',
        value: function render() {
            return _react2.default.createElement(
                'div',
                { id: 'gauge' },
                _react2.default.createElement('svg', { id: 'gauge-svg', height: '700px', width: '800px' })
            );
        }
    }]);
